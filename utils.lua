function DrawText3D(coords, texts, scale, alpha)
	...
	for _, text in pairs(texts) do
		SetTextScale((text.scale or 0.5) * scale, (text.scale or 0.5) * scale)
		SetTextFont(4)
...
function getPedHeadCoords(ped)
	...
	coords = coords == vector3(0, 0, 0) and GetEntityCoords(ped) + vector3(0, 0, 0.9) or coords + vector3(0, 0, 0.31)
